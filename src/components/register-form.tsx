    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        <div className="grid gap-3">
          ...
          <Input id="nama" type="text" placeholder="test@contoh.com" required />
        </div>
        <div className="grid gap-3">
        ...
        <div className="grid gap-3 relative"> {/* Tambahkan 'relative' untuk posisi ikon */}
          ...
          <Input
            id="konfirmasipassword" // Pastikan ID ini unik
            type={showConfirmPassword ? "text" : "password"} // Ubah tipe berdasarkan state
            placeholder="Password1"
            required
